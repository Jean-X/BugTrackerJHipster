...
import { MessengerSharedModule } from 'app/shared';
import { MessengerCoreModule } from 'app/core';
import { MessengerAppRoutingModule } from './app-routing.module';
import { MessengerHomeModule } from './home/home.module';
import { MessengerAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        MessengerSharedModule.forRoot(),
        MessengerCoreModule,
        MessengerHomeModule,
        MessengerAccountModule,
